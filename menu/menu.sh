...
res1() {
    wget https://raw.githubusercontent.com/KhaiVpn767/V5/main/menu/menu.zip
    unzip menu.zip
    chmod +x menu/*
...
echo ""
izinsc="https://raw.githubusercontent.com/KhaiVpn767/V5/main/Regist"
# USERNAME
rm -f /usr/bin/user
...
#echo -e " ${z}│$NC$r ⇲ $NC$y Ns-Domain ${NC}     $Blue=$NC ${BIYellow}$(cat /root/nsdomain)${NC}"
echo -e " ${z}╰══════════════════════════════════════════════════════════╯${NC}"
echo -e "       ───────────────────────────────────────────────${NC}" | lolcat 
echo -e "           ${CYAN}SSH/OPENVPN${NC}    $y=$NC $ssh1${NC}" "$a" | lolcat
echo -e "           VMESS/WS/GRPC${NC}  $y=$NC $vma$NC" "$a" | lolcat
echo -e "           VLESS/WS/GRPC${NC}  $y=$NC $vla$NC" "$a" | lolcat
echo -e "           TROJAN/WS/GRPC${NC} $y=$NC $trb${NC}" "$a" | lolcat
echo -e "           SHADOW/WS/GRPC${NC} $y=$NC $ssa${NC} $a" | lolcat
echo -e "       ───────────────────────────────────────────────${NC}" | lolcat 
echo -e " ${z}╭════════════════╮╭══════════════════╮╭════════════════════╮${NC}"
...
echo -e " ${z}│$NC [${r}07${NC}]$purple CEK RAM/CPU$NC  ${z}│$NC [${r}14${NC}]$purple autobackup$NC ${z}  │$NC [${r}21${NC}]$purple CLEAR CACHE $NC${z}│$NC"
...
echo -e " ${z}│$NC [${r}27${NC}]$purple Helium ${KANAN} \E[0m\033[0;34m                                         $NC${z}│$NC"
echo -e " ${z}╰══════════════════════════════════════════════════════════╯${NC}"
echo -e " ${z}╭══════════════════════════════════════════════════════════╮${NC}"
...
27)
clear
wget https://raw.githubusercontent.com/KhaiVpn767/V5/refs/heads/main/menu/m-helium.sh && chmod +x m-helium.sh && ./m-helium.sh
echo ""
